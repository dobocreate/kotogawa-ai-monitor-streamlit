...
if not model_info:
    ...
    with col1:
        ...
        st.metric(
            "学習サンプル数",
            f"{samples:,}件",
            delta=f"過去1時間: +{prediction_stats['last_hour']}件" if model_type == "適応モデル（継続学習）" and prediction_stats['last_hour'] > 0 else None,
